    ...
    public class Player : MonoBehaviour
    {
        ...
        private Vector3 CurrentLeftHandPosition()
        {
            ...
            else
            {
                return headCollider.transform.position +
                       (PositionWithOffset(leftHandTransform, leftHandOffset) - headCollider.transform.position).normalized *
                       maxArmLength;
            }
        }
        ...
        private void Update()
        {
            ...
            Vector3 distanceTraveled =
                CurrentLeftHandPosition() - lastLeftHandPosition +
            ...
            if ((leftHandColliding || wasLeftHandTouching) &&
                (rightHandColliding || wasRightHandTouching))
            {
                ...
                false))
            {
                ...
                if (Physics.Raycast(
                    lastHeadPosition,
                    headCollider.transform.position - lastHeadPosition + rigidBodyMovement,
                    out hitInfo,
            ...
            if (IterativeCollisionSphereCast(
                ...
                defaultPrecision,
                out finalPosition,
                !((leftHandColliding || wasLeftHandTouching) &&
                  (rightHandColliding || wasRightHandTouching))))
            {
            ...
            if (leftHandColliding &&
                ...
                !Physics.SphereCast(
                    ...
                    out hitInfo,
                    (CurrentLeftHandPosition() - headCollider.transform.position).magnitude -
                    minimumRaycastDistance,
                    locomotionEnabledLayers.value))
            {
                lastLeftHandPosition = CurrentLeftHandPosition();
            ...
            if (rightHandColliding &&
                (CurrentRightHandPosition() - lastRightHandPosition).magnitude > unStickDistance &&
                !Physics.SphereCast(
                    headCollider.transform.position,
                    minimumRaycastDistance * defaultPrecision,
                    CurrentRightHandPosition() - headCollider.transform.position,
                    out hitInfo,
                    (CurrentRightHandPosition() - headCollider.transform.position).magnitude -
                    minimumRaycastDistance,
                    locomotionEnabledLayers.value))
            {
                lastRightHandPosition = CurrentRightHandPosition();
            ...
            bool singleHand)
        {
                ...
                out hitInfo))
            {
                ...
                slipPercentage = gorillaSurface != null
                ...
                (movementVector.magnitude + sphereRadius * precision * 0.34f),
                precision * 0.66f,
                out endPosition,
                out hitInfo))
            {
            ...
            out RaycastHit hitInfo)
        {
                ...
                locomotionEnabledLayers.value))
            {
                ...
                if (Physics.SphereCast(
                    ...
                    sphereRadius * (1 - precision * precision),
                    locomotionEnabledLayers.value))
                {
                    finalPosition =
                        startPosition +
                        (finalPosition - startPosition).normalized *
                        Mathf.Max(0, hitInfo.distance -
                        sphereRadius * (1f - precision * precision));
        ...
        private void StoreVelocities()
        {
            ...
            denormalizedVelocityAverage +=
                (currentVelocity - oldestVelocity) / velocityHistorySize;
